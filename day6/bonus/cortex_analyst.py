...
Using the semantic model at:
{SEMANTIC_MODEL}

Generate and execute SQL to answer this question:
...
SQL: <the sql query>
ANSWER: <friendly business answer>
"""
    ...
    print(f"[Cortex] Response received in {elapsed:.2f}s")
...
- Join FACT_TRANSACTIONS to DIM_MERCHANT using MERCHANT_ID
